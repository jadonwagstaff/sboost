...
#'         generated by \code{\link{sboost_assess}} cumulative statistics for each of the training sets.}
#'   \item{\emph{testing_summary_statistics}}{Mean and standard deviations for test statistics
#'         generated by \code{\link{sboost_assess}} cumulative statistics for each of the testing sets.}
